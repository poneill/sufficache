...
# Code on this page belongs to the pysuffix project
# (http://code.google.com/p/pysuffix/), and is released under GPL v2.
# Excepting minor modifications, it was not written by PON.
